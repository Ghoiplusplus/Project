...
from mocks.auth import check_token, logout, authorize_user
from mocks.main_module import get_tests, get_test_details, get_test_questions, create_attempt, submit_answer, get_attempt_results
...
async def get_test_questions_history(message: types.Message):
    ...
    await message.answer("Вопрос 1 : ..., ответы: [1, 2, 3]                               "

                         "                                Вопрос 2 : ... ответы: [1, 2, 3]")
